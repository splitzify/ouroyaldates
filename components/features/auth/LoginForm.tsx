    ...
    <div className="w-full max-w-sm space-y-6">
      <AnimatedContent distance={30} direction="vertical" duration={0.6} delay={0.1}>
        <div className="text-center space-y-1">
          ...
          <p className="text-white/60 text-sm">Sign in to plan your next date</p>
        </div>
      </AnimatedContent>
      ...
      <AnimatedContent distance={20} direction="vertical" duration={0.6} delay={0.3}>
        <p className="text-center text-white/50 text-sm">
          No account yet?{' '}
          <Link href="/signup" className="text-rose-300 hover:text-rose-200 font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </AnimatedContent>
